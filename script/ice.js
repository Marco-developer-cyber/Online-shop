...
for (let i = 1; i <= 20; i++) {
    ...
    div.innerHTML = `
    <img src = "../media/ice-cream/${ice_cream_json[i]['img']}" alt = "img" class="product_img">
        <div class="product_data">
            <p class="name">name: ${ice_cream_json[i]['name']}</p>
            <p class="price"> price: ${ice_cream_json[i]['price']}</p>
