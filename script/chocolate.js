...
for (let i = 1; i <= 24; i++) {
    ...
    div.innerHTML = `
    <img src = "../media/chocolate/${chocolate_json[i]['img']}" alt = "img" class="product_img">
        <div class="product_data">
            <p class="name">name: ${chocolate_json[i]['name']}</p>
            <p class="price"> price: ${chocolate_json[i]['price']}</p>
